...
void SearchTextTest::test_hebrewSearch()
{
    ...
    ToolResult addResult = runAlbdfTool(toolPath,
    ...
    ToolResult searchResult =
        runAlbdfTool(toolPath, {QStringLiteral("search-text"), inputPath, QString::fromUtf8("שלום")}, tmpDir.path());
...
void SearchTextTest::test_persianDigits()
{
    ...
    ToolResult searchResult =
        runAlbdfTool(toolPath, {QStringLiteral("search-text"), inputPath, QStringLiteral("123")}, tmpDir.path());
    QCOMPARE(searchResult.exitCode, 0);
    QVERIFY2(QString::fromUtf8(searchResult.stdoutData).contains(QStringLiteral("1\n")),
...
void SearchTextTest::test_zwnjInsensitive()
{
    ...
    ToolResult searchResult =
        runAlbdfTool(toolPath, {QStringLiteral("search-text"), inputPath, withoutZwnj}, tmpDir.path());
    QCOMPARE(searchResult.exitCode, 0);
    QVERIFY2(QString::fromUtf8(searchResult.stdoutData).contains(QStringLiteral("1\n")),
...
void SearchTextTest::test_tashkeelInsensitive()
{
    ...
    ToolResult searchResult =
        runAlbdfTool(toolPath, {QStringLiteral("search-text"), inputPath, withoutTashkeel}, tmpDir.path());
    QCOMPARE(searchResult.exitCode, 0);
    QVERIFY2(QString::fromUtf8(searchResult.stdoutData).contains(QStringLiteral("1\n")),
...
void SearchTextTest::test_mixedBidi()
{
    ...
    ToolResult ltrResult =
        runAlbdfTool(toolPath, {QStringLiteral("search-text"), inputPath, QStringLiteral("Hello")}, tmpDir.path());
    ...
    ToolResult rtlResult =
        runAlbdfTool(toolPath, {QStringLiteral("search-text"), inputPath, QString::fromUtf8("دنیا")}, tmpDir.path());
...
void SearchTextTest::test_noFalsePositive()
{
    ...
    ToolResult searchResult =
        runAlbdfTool(toolPath, {QStringLiteral("search-text"), inputPath, QStringLiteral("world")}, tmpDir.path());
    QCOMPARE(searchResult.exitCode, 0);
