...
mcp_servers:
  context7:
    ...
    headers:
      Authorization: "Bearer ctx7sk-2c7fa156-7263-4e9a-95ac-ef0417f28179"
```
...
hermes config set mcp_servers.context7.headers.Authorization "Bearer ctx7sk-2c7fa156-7263-4e9a-95ac-ef0417f28179"
```
