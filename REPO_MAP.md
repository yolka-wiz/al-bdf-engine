...
| `docs/RELEASES.md` | albdf — release notes | Date: 2026-08-05 Branch: `main` (GitHub: yolka-wiz/al-bdf-engine) - **Rename:** project and CLI renamed from `pdfedit`/`PdfTool` to **albdf**. |
