...
| `plans/m14-upstream-sync-testing-execution-2026-08-08.md` | M14 Completion + Upstream Sync + Real-PDF Testing — Execution Plan | > **Status:** ACTIVE — 2026-08-08. Orchestrator: yolka. > **For Hermes:** execute phase-by-phase; verify every child claim; gate before merge. **Goal:** (1) complete and merge the… |
